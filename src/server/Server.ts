    ...
    public static async bootstrap(config: ServerConfig): Promise<NestExpressApplication> {
        ...
        if (config.swagger) {
            ...
            const documentBuilder = new DocumentBuilder()
                ...
                .setContact(
                    config.swagger.contactName,
                    config.swagger.contactUrl,
                    config.swagger.contactEmail
                )
            ...
            SwaggerModule.setup(
                ...
                SwaggerModule.createDocument(
                    ...
                    config.swagger.documentOptions
                ),
        ...
        console.log(
            `${new Date().toISOString()} ${config.name} server started on port ${config.port}`
        );
